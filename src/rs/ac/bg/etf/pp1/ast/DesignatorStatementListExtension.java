...
public class DesignatorStatementListExtension extends DesignatorStatementList {

    private DesignatorStatementList DesignatorStatementList;
    private DesignatorStatement DesignatorStatement;

    public DesignatorStatementListExtension (DesignatorStatementList DesignatorStatementList, DesignatorStatement DesignatorStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementListExtension(\n");
