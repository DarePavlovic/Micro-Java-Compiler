...
public class DesigStateOptional extends DesigStateBrack {

    private DesignatorStatementList DesignatorStatementList;

    public DesigStateOptional (DesignatorStatementList DesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesigStateOptional(\n");
